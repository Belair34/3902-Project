...
namespace Game1
{
    class ProjAquaFireballLeft : AbstractProjectile, IProjectile
    {

        public ProjAquaFireballLeft(IEnemy enemy)
        {
            this.enemy = enemy;
            shooting = false;
            exploding = false;
            ...
            sprite = SpriteFactory.Instance.GetAquaFireballLeft(this);
        }
